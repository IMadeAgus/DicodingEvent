...
class HomeUpcomingAdapter(private val onItemClick: (ListEventsItem) -> Unit) :
    ListAdapter<ListEventsItem, HomeUpcomingAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    class MyViewHolder(
        private val binding: ItemHomeUpcomingEventBinding,
